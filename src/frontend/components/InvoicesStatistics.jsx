            ...
            {!loading && (
                <div id="invoicesStatisticsContainer">
                    <div id="invoicesStatististicSoldUnits" className="invoices-statistic">
                        <h3>{soldProducts} / {totalProducts}</h3>
                        <h5><i className="fas fa-balance-scale"></i>&nbsp;Unidades vendidas</h5>
                    </div>
                    <div id="invoicesStatististicNetValue" className="invoices-statistic">
                        <h3>$ {earnedMoney - investedMoney}</h3>
                        <h5><i className="fas fa-hand-holding-usd"></i>&nbsp;Ganancia neta</h5>
                    </div>
                    <div id="invoicesStatististicEarned" className="invoices-statistic">
                        <h3>$ {earnedMoney}</h3>
                        <h5><i className="fas fa-chevron-up"></i>&nbsp;Ingresos</h5>
                    </div>
                    <div id="invoicesStatististicInvested" className="invoices-statistic">
                        <h3>$ {investedMoney}</h3>
                        <h5><i className="fas fa-chevron-down"></i>&nbsp;Gastos</h5>
                    </div>
                </div>
            )}
        </>
